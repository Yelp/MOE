...
_DefaultOptimizerInfoTuple = namedtuple('_DefaultOptimizerInfoTuple', [
    'num_multistarts',
    'num_random_samples',
    'optimizer_parameters',
])

_EI_ANALYTIC_DEFAULT_OPTIMIZER = _DefaultOptimizerInfoTuple(
...
_GRADIENT_DESCENT_MODEL_SELECTION_DEFAULT_OPTIMIZER = _DefaultOptimizerInfoTuple(
...
# It is also not implemented for any of the GP_NEXT_POINTS_* endpoints.
OPTIMIZER_TYPE_AND_OBJECTIVE_TO_DEFAULT_PARAMETERS = {
    ...
    (GRADIENT_DESCENT_OPTIMIZER, views_constant.GP_NEXT_POINTS_EPI_ROUTE_NAME, EI_COMPUTE_TYPE_MONTE_CARLO): _DefaultOptimizerInfoTuple(
    ...
    (GRADIENT_DESCENT_OPTIMIZER, views_constant.GP_HYPER_OPT_ROUTE_NAME, LEAVE_ONE_OUT_LOG_LIKELIHOOD): _GRADIENT_DESCENT_MODEL_SELECTION_DEFAULT_OPTIMIZER,
    (GRADIENT_DESCENT_OPTIMIZER, views_constant.GP_HYPER_OPT_ROUTE_NAME, LOG_MARGINAL_LIKELIHOOD): _GRADIENT_DESCENT_MODEL_SELECTION_DEFAULT_OPTIMIZER,
    (NEWTON_OPTIMIZER, views_constant.GP_HYPER_OPT_ROUTE_NAME, LOG_MARGINAL_LIKELIHOOD): _DefaultOptimizerInfoTuple(
