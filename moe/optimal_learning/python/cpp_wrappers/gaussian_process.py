...
class GaussianProcessNew(GaussianProcessInterface):
    ...
    def __init__(self, covariance_function, historical_data, num_IS_in):
        """Construct a GaussianProcess object that knows how to call C++ for evaluation of member functions.
        ...
        self._num_IS = num_IS_in
        print self._num_IS

        # C++ will maintain its own copy of the contents of hyperparameters and historical_data
        self._gaussian_process = C_GP.GaussianProcessNew(
