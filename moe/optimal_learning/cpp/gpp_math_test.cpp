...
// class PingOnePotentialSampleExpectedImprovement definition begins
...
// PingExpectedImprovement member function definitions begin
...
OL_WARN_UNUSED_RESULT int ExpectedImprovementOptimizationTestCore(ExpectedImprovementEvaluationMode ei_mode) {
  ...
  if (ei_mode == ExpectedImprovementEvaluationMode::kAnalytic) {
    ...
    OnePotentialSampleExpectedImprovementEvaluator::StateType ei_state(ei_evaluator, next_point.data(), configure_for_gradients);
