...
int main() {
  ...
  ComputeOptimalPointToSampleWithRandomStarts(gp, gd_params, domain, points_being_sampled.data(), num_being_sampled, best_so_far, max_int_steps, max_num_threads, &found_flag, &uniform_generator, normal_rng_vec.data(), next_point_winner.data());
