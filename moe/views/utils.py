...
def _make_optimizer_parameters_from_params(params):
    ...
    :param params: the deserialized REST request, containing ei_optimizer_parameters
    :type params: a dictionary with a key ei_optimizer_parameters containing a :class:`moe.views.schemas.EiOptimizerParameters()` object with optimizer parameters
...
def _make_bandit_historical_info_from_params(params):
    ...
    ``params`` has the following form::
        ...
        params = {
            'historical_info': <instance of moe.rest.schemas.BanditHistoricalInfo>,
            }
