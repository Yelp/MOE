...
from moe.bandit.constant import DEFAULT_HISTORICAL_INFO
...
class BanditPrettyView(Root):
    ...
    _pretty_default_historical_info = DEFAULT_HISTORICAL_INFO

    def __init__(self, request):
        """Store the request for the view and set up the logger."""
        super(BanditPrettyView, self).__init__(request)
