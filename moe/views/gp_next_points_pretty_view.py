...
import moe.build.GPP as cpp_gaussian_process
...
class GpNextPointsPrettyView(GpPrettyView):
    ...
    def get_optimization_parameters_cpp(deserialized_request_params):
        ...
        new_params.domain_type = cpp_gaussian_process.DomainTypes.tensor_product
        return new_params
