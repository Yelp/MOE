...
<div class="background-image">
  ...
  <ul>
    <li><h5>GP Mean, [Co]Variance</h5>
      <ul>
	<li><a href="${request.route_url( 'gp_mean_pretty' )}">GP mean</a></li>
	<li><a href="${request.route_url( 'gp_var_pretty' )}">GP covariance</a></li>
	<li><a href="${request.route_url( 'gp_var_diag_pretty' )}">GP variance</a></li>
	<li><a href="${request.route_url( 'gp_mean_var_pretty' )}">GP mean and covariance</a></li>
	<li><a href="${request.route_url( 'gp_mean_var_diag_pretty' )}">GP mean and variance</a></li>
      </ul>
    </li>
    <li><a href="${request.route_url( 'gp_ei_pretty' )}">GP EI</a></li>
    <li><h5>Next Points To Sample Prediction</h5>
      <ul>
