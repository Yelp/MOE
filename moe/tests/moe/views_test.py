...
class TestGpMeanVarView(RestGaussianProcessTestCase):
    ...
    test_cases = [
            {
                'domain': domain_1d,
                'points_to_sample': get_latin_hypercube_points(10, domain_1d),
                'num_points_in_sample': 10,
                },
            {
                'domain': domain_2d,
                'points_to_sample': get_latin_hypercube_points(10, domain_2d),
                'num_points_in_sample': 10,
                },
            {
                'domain': domain_3d,
                'points_to_sample': get_latin_hypercube_points(10, domain_3d),
                'num_points_in_sample': 10,
                },
            ]
...
class TestGpNextPointsEiView(RestGaussianProcessTestCase):
    ...
    def test_interface_returns_same_as_cpp(self):
        ...
        for test_case in self.test_cases:
            ...
            ei_optimization_parameters.domain_type = C_GP.DomainTypes.tensor_product
...
class TestGpEiView(RestGaussianProcessTestCase):
    ...
    test_cases = [
            {
                'domain': domain_1d,
                'points_to_evaluate': get_latin_hypercube_points(10, domain_1d),
                'num_points_in_sample': 10,
                },
            {
                'domain': domain_2d,
                'points_to_evaluate': get_latin_hypercube_points(10, domain_2d),
                'num_points_in_sample': 10,
                },
            {
                'domain': domain_3d,
                'points_to_evaluate': get_latin_hypercube_points(10, domain_3d),
                'num_points_in_sample': 10,
                },
            ]
