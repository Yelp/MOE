...
The C++ is independently tested (see moe/optimal_learning/EPI/src/cpp/*test.cpp files) as is the Python\*
(see moe/tests/EPI/src/python/python_version), so the tests in this package generally are not very exhaustive.
