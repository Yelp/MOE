...
from moe.optimal_learning.EPI.src.python.geometry_utils import generate_latin_hypercube_points, ClosedInterval
...
class LatinHypercubeRandomPointGenerationTest(OptimalLearningTestCase):
    ...
    """Test moe.optimal_learning.EPI.src.python.geometry_utils.generate_latin_hypercube_points.
