...
import moe.optimal_learning.EPI.src.python.gaussian_process_utils as gp_utils
...
from moe.tests.EPI.src.python.optimal_learning_test_case import OptimalLearningTestCase
