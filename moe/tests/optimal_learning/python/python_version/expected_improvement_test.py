    ...
    def test_qd_ei_with_self(self):
        ...
        for test_case in self.gp_test_environments[2:3]:
            ...
            for i in range(2, 10):
                ...
                print 'rel: {0:.18E}, abs: {1:.18E}, val: {2:.18E}'.format((python_qd_ei - precomputed_answers[i - 2]) / precomputed_answers[i - 2], python_qd_ei - precomputed_answers[i - 2], python_qd_ei)
