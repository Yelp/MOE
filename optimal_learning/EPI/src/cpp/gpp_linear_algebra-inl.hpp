...
#ifndef OPTIMAL_LEARNING_EPI_SRC_CPP_GPP_LINEAR_ALGEBRA_INL_HPP_
#define OPTIMAL_LEARNING_EPI_SRC_CPP_GPP_LINEAR_ALGEBRA_INL_HPP_
...
/*
  Computes A = alpha*v*u^T + A, where v * u^T is the outer product of v with u, where
...
/*
  ...
  Finally, for matrix-products A*B, when A is stored column-major, we use the view of matrix-vector multiply, Ax, as a weighted
  sum of the columns of A.  This improves memory access patterns.  But here, such an arrangement is impossible and we have
  to access A in a "bad" ordering.
...
#endif  // OPTIMAL_LEARNING_EPI_SRC_CPP_GPP_LINEAR_ALGEBRA_INL_HPP_
